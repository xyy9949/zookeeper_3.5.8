...
class AckRequestProcessor implements RequestProcessor {
    ...
    public void processRequest(Request request) {
        ...
        if(self != null) {
            ...
            {
                StateCollectingUtil stateCollectingUtil = new StateCollectingUtil(self.getId(), "PROPOSE", request.zxid, request.zxid+"-ACK");
                stateCollectingUtil.generateStateContextPropose(leader);
